        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$5, { color: "text" }))),
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$k, { color: "text" })))),
...
var Logo = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 30 20" }, props),
        React__default['default'].createElement("image", { width: "20", height: "20", href: isDark ? "/images/DarkLogo.png" : "/images/RedLogo.png" })));
};
...
var Icon$18 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "48px", height: "48px" },
            ...
            React__default['default'].createElement("path", { fill: "rgb(250 133 52)", d: "M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z" }))));
};
...
var Icon$19 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "48px", height: "48px" },
            ...
            React__default['default'].createElement("path", { fill: "rgb(250 133 52)", d: "M20 31L20 17 32 24z" }))));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { style: { marginBottom: "30px" }, "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$M, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$L, { width: "24px", color: "textSubtle" }))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f1f1", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#B0B0B0", tertiary: "rgb(12, 12, 78)" /* "#EFF4F5",*/, text: "#1D1746" /*   "#FF0000" "#452A7A" */, textDisabled: "#BDC2C4", textSubtle: "#000034" /* "#8f80ba" */, borderColor: "#E9EAEB", card: "#f2f8fb", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#EAE2FC" /* "#9A6AFF", */, background: "#f1f1f1" /* "#343135", */, backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#B0B0B0", primaryDark: "#0098A1", tertiary: "rgb(12, 12, 78)" /* "#EFF4F5",*/, text: "#ffffff" /*   "#FF0000" "#452A7A" */, textDisabled: "#BDC2C4", textSubtle: "#f1f1f1" /* "#8f80ba" */, borderColor: "#E9EAEB", card: "#000034", gradients: {
